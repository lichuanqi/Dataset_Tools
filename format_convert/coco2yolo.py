...
parser.add_argument('--json_path', default='D:/Code/DATASET/5151/validation/labels.json',type=str, help="input: coco format(json)")
parser.add_argument('--save_path', default='D:/Code/DATASET/5151/validation/txt', type=str, help="specify where to save the output dir of labels")
